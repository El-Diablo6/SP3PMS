             ...
             <form action="bookingservlet" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="pickupTime" name="pickupTime" min="<%=formattedDate%>" required>
                    </div>
                        <br>
                        <br>
                        <div class="dropoff">
                        <label for="dropTime">Dropoff Time:</label>
                        <input type="datetime-local" id="dropTime" name="dropTime" min="<%=formattedDate%>" required>
                    </div>
                    </div>
